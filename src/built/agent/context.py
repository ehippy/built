...
def build_developer_prompt(
    ...
    *,
    ...
    system = (
        ...
        "keep trying pip installs or use pip --no-user: create Dockerfile.built-sandbox in the repo root "
        "with the required dependencies, then call build_sandbox and repeat the failed command. Whenever "
